...
function onSignIn(googleUser) {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open('POST', '');
    xhr.setRequestHeader('Content-Type', 'https://clowns-who-code.herokuapp.com/');
    xhr.onload = function () {
        console.log('Signed in as: ' + xhr.responseText);
    };
    xhr.send('idtoken=' + id_token);
    console.log(`Sucessfully Verified ${profile.getName()} in...\n Current Session Token: ${id_token}`);
}

trySampleRequest();
onSignIn("sts321@lehigh.edu");
